                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="">NIK</label>
                                    <input type="number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control form-control-user check-nik" name="nik" minlength="16" maxlength="16" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control form-control-user" name="no_kk"  maxlength="16"  minlength="16" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" name="tmpt_lhr" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-user" name="warga_negara" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" name="nama_ayah" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-user" name="gol_darah" required>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" name="no_hp" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="15" required>
                                </div>

                                <div class="form-group">
                                    <label for="">Pendidikan Terakhir</label>
                                    <select class="form-control form-control-user" name="pendidikan" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-user" name="pekerjaan" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-user" name="status_nikah" required>
